    ...
    <div>
      <div className='bg-[url("/img/footer-bg.png")] bg-no-repeat bg-cover py-[75px] bg-center w-full px-3'>
        ...
        <div className="max-w-[900px] w-full mx-auto rounded-[40px] border-[2px] h-[50px] md:h-[80px] pl-2 sm:pl-4  md:pl-5 border-white bg-[rgba(0,0,0,0.40)]">
          <form action=".php" className="flex justify-between items-center">
            {/* input */}
            <input
              type="email"
              placeholder="Enter e-mail to recieve news letter"
              className=" max-sm:pl-2 sm:w-[342px] bg-transparent text-white outline-none placeholder:text-[#fff] 
      ...
      <div className="max-w-[1050px] w-full mx-auto mt-[50px] max-sm:px-[12px] px-3">
        <div className=" mx-auto flex gap-[20px] gap-y-10 flex-wrap justify-evenly md:justify-between">
          {/* logo */}
          <div>
            <div>
              <Image
            ...
            <p className="text-black text-[20px] font-poppins font-normal leading-[160%] max-w-[264px] w-full pt-[19px]">
          ...
          <div className="flex flex-col gap-[20px]">
            ...
            <p className="text-black font-normal leading-[21px] font-poppins text-[20px]">
              Home
            </p>
            <p className="text-black font-normal leading-[21px] font-poppins text-[20px]">
              About us
          ...
          <div className="flex flex-col gap-[20px]">
            ...
            <p className="text-black font-normal leading-[33px] font-poppins text-[20px] flex items-center gap-1">
              <EmailIcon /> Loremipilum11@gmail.com
            </p>
            <div className="text-black font-normal leading-[33px] font-poppins text-[20px] flex gap-1">
              <PhoneIcon />
              <div>
          ...
          <div className="flex flex-col gap-[20px]">
            ...
            <p className="text-black font-normal leading-[21px] font-poppins text-[20px] flex items-center gap-[20px]">
              <FbIcon /> Facebook
            </p>
            <p className="text-black font-normal leading-[21px] font-poppins text-[20px] flex items-center gap-[20px]">
              <TWitterIcon /> Twitter
